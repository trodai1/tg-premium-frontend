...
const I18N = {
  ru: {
    app_title: 'NewSaaS',
    app_subtitle: 'Premium Business',
    app_tagline: 'Лаконично, быстро, по-телеграмному',
    lang_btn: 'EN',

    status_title: 'Статус',
    status_check: 'Проверка окружения…',
    status_auth_ok: 'Готово: авторизация',
    status_auth_fail_ext: 'Открыто вне Telegram. Авторизация не выполнена.',
    status_auth_hint_ext: 'Открой через кнопку у бота.',
    status_auth_init_empty: 'Открыто в Telegram, но initData пустая.',
    status_auth_hint_update: 'Обнови Telegram и открой через кнопку у бота.',
    status_loading: 'Загрузка…',
    status_ready: 'Готово',
    status_deal_added: 'Сделка добавлена',
    status_task_added: 'Задача добавлена',
    status_deal_add_err: 'Ошибка добавления сделки',
    status_task_add_err: 'Ошибка добавления задачи',
    status_pf_updated: 'Портфель обновлён',
    status_input_company: 'Введите название компании',
    status_input_task: 'Введите название задачи',
    confirm_del_deal: 'Удалить сделку?',
    confirm_del_task: 'Удалить задачу?',
    confirm_clear_deals: 'Удалить все сделки?',
    confirm_clear_tasks: 'Удалить все задачи?',

    crm_title: 'CRM — Клиенты',
    crm_add: 'Добавить сделку',
    crm_clear: 'Очистить сделки',
    crm_company_ph: 'Компания',
    crm_owner_ph: 'Менеджер',
    crm_amount_ph: 'Сумма, $',
    crm_list_empty: 'Пока пусто — добавьте сделку через форму выше.',
    crm_stage_lbl: 'Этап',
    crm_owner_lbl: 'Менеджер',
    crm_amount_lbl: 'Сумма',
    edit: 'Ред.',
    del: 'Удалить',
    all_deals_deleted: 'Все сделки удалены',

    tasks_title: 'Tasks — Задачи',
    tasks_add: 'Добавить задачу',
    tasks_clear: 'Очистить задачи',
    task_title_ph: 'Название задачи',
    task_tag_ph: 'Тег (sales/ops…)',
    task_due_ph: 'Дата',
    tasks_list_empty: 'Пока пусто — добавьте задачу через форму выше.',
    all_tasks_deleted: 'Все задачи удалены',

    crypto_title: 'Crypto — Рынок',
    refresh: 'Обновить',
    crypto_empty: 'Нет данных. Нажмите «Обновить».',
    crypto_source: 'Источник: Binance → OKX → Bybit (кэш 10с).',

    pf_title: 'Портфель',
    pf_total: 'Итого: {v}',
    pf_amount_ph: 'Количество',
    pf_add: 'Добавить в портфель',
  ...
  en: {
    app_title: 'NewSaaS',
    app_subtitle: 'Premium Business',
    app_tagline: 'Minimal, fast, Telegram-native',
    lang_btn: 'RU',

    status_title: 'Status',
    status_check: 'Checking environment…',
    status_auth_ok: 'Done: authorized',
    status_auth_fail_ext: 'Opened outside Telegram. Auth not performed.',
    status_auth_hint_ext: 'Open via the bot button.',
    status_auth_init_empty: 'Opened in Telegram, but initData is empty.',
    status_auth_hint_update: 'Update Telegram and open via the bot button.',
    status_loading: 'Loading…',
    status_ready: 'Ready',
    status_deal_added: 'Deal added',
    status_task_added: 'Task added',
    status_deal_add_err: 'Failed to add deal',
    status_task_add_err: 'Failed to add task',
    status_pf_updated: 'Portfolio updated',
    status_input_company: 'Enter company name',
    status_input_task: 'Enter task title',
    confirm_del_deal: 'Delete deal?',
    confirm_del_task: 'Delete task?',
    confirm_clear_deals: 'Delete all deals?',
    confirm_clear_tasks: 'Delete all tasks?',

    crm_title: 'CRM — Clients',
    crm_add: 'Add deal',
    crm_clear: 'Clear deals',
    crm_company_ph: 'Company',
    crm_owner_ph: 'Owner',
    crm_amount_ph: 'Amount, $',
    crm_list_empty: 'Empty — add a deal above.',
    crm_stage_lbl: 'Stage',
    crm_owner_lbl: 'Owner',
    crm_amount_lbl: 'Amount',
    edit: 'Edit',
    del: 'Delete',
    all_deals_deleted: 'All deals removed',

    tasks_title: 'Tasks',
    tasks_add: 'Add task',
    tasks_clear: 'Clear tasks',
    task_title_ph: 'Task title',
    task_tag_ph: 'Tag (sales/ops…)',
    task_due_ph: 'Due date',
    tasks_list_empty: 'Empty — add a task above.',
    all_tasks_deleted: 'All tasks removed',

    crypto_title: 'Crypto — Market',
    refresh: 'Refresh',
    crypto_empty: 'No data. Tap “Refresh”.',
    crypto_source: 'Source: Binance → OKX → Bybit (cache 10s).',

    pf_title: 'Portfolio',
    pf_total: 'Total: {v}',
    pf_amount_ph: 'Amount',
    pf_add: 'Add to portfolio',
...
function setLang(lang){
  ...
  applyTexts();
  // перерисуем списки, чтобы подписи сменились
  loadClients().catch(()=>{});
  loadTasks().catch(()=>{});
  renderCrypto(lastMarkets || []);
...
function applyTexts(){
  ...
  // placeholders & buttons (forms)
  els.cCompany.placeholder = t('crm_company_ph');
  els.cOwner.placeholder   = t('crm_owner_ph');
  els.cAmount.placeholder  = t('crm_amount_ph');
  els.cAdd.textContent     = t('crm_add');
  els.cClear.textContent   = t('crm_clear');

  els.tTitle.placeholder   = t('task_title_ph');
  els.tTag.placeholder     = t('task_tag_ph');
  els.tDue.placeholder     = t('task_due_ph');
  els.tAdd.textContent     = t('tasks_add');
  els.tClear.textContent   = t('tasks_clear');

  els.pfAmount.placeholder = t('pf_amount_ph');
  els.pfAdd.textContent    = t('pf_add');
  // статус стартовый
...
async function api(path, opts = {}, retry = true) {
  ...
  if (!res.ok) {
    ...
    if (retry && needReauth) { localStorage.removeItem('pb_token'); TOKEN=''; const ok = await auth(); if (ok) return api(path, opts, false); }
    throw data;
  }
  return data;
}
...
async function auth(){
  ...
  try{
    ...
    if(res.ok && res.token){
      ...
      setStatus(t('status_auth_ok'),'ok'); $('#user-id').textContent = res.user?.id ? `User ID: ${res.user.id}` : ''; setHelp(''); return true;
    } else { setStatus('Auth error','err'); setHelp(res.reason || res.error || ''); return false; }
...
async function boot(){
  ...
  if (!ok) { setStatus('Auth error','err'); return; }
